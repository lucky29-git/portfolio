...
import ButtonWebsite from "./myComponents/buttonWebsite";
import { div } from "framer-motion/client";
import { title } from "process";

export default function CardDemo3({img_path, title, date, description, website_path, code_path}: {
  img_path: string, 
  title: string,
  date: string,
  description: string,
  ...
  return (
    <Card>
      <CardSkeletonContainer>
        <CardDisplay path={img_path} />
      </CardSkeletonContainer>
      <CardTitle>{title}</CardTitle>
      <CardDescription>
        <div className="-mt-2 text-xs text-gray-400 dark:text-gray-400">{date}</div>
        <div className="pt-2">
          {description}
        </div>
        ...
        <div className="pt-4 flex gap-2">
          <ButtonWebsite title="Website" path={website_path} />
          <ButtonWebsite title="<> Code" path={code_path}/>
        </div>
      </CardDescription>
...
function CardDisplay({path}: {path: string}){
  return (
